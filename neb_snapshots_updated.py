...
def read_spline_file(fname):
    with open(fname, encoding='utf-8') as input_data:
        listi = []
        images = []
        spline = []
...
if __name__ == "__main__":
    ...
    update for python 3 and plot units: Mateus Paiva (UFMG,2023)
    """
...
for i in range(start_from, end_at):
    ...
    # convert energy from Ha to kJ/mol
    Eimg = [energy * 2625.5 for energy in Eimg]
    Eimg2 = [energy * 2625.5 for energy in Eimg2]

    # convert Bohr distance to Angstrom
    arcS = [dist * 0.529177 for dist in arcS]
    arcS2 = [dist * 0.529177 for dist in arcS2]
...
# save whole profile
plt.xlabel("Displacement [Å]", fontsize=15)
